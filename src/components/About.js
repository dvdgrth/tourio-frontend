  ...
  return (
    <div className="about-grid">
      ...
      <p>
        ...
        expert on the topic, maybe not - but always with a different personal
        perspective to it.
      </p>
      <p>
        Ever done a deep googleing session on a topic? Ever wondered if somebody
        else has already searched the exact same thing? There should be some way
        to "save and share" a search session, meaning the best (most helpful,
        interesting etc.) links one can find should be shareable. This way we
        would skip or shorten the initial phase of crambling and often suffering
        through the mud in search for the nuggets. If we could start with the
        best finds of somebody else, we probably would often still want to
        search for ourselves but the suggestions could give us valuable starting
        point for our own search or links we would not have been able to find on
        our own.
      </p>

      <p>
        We should remember the adventerous, elegant spirit of the early web: An
        ocean of ressources, of sites, of space stations if you will - connected
        by links, by waterways, by rocket routes. A "web" is woven, a new world
        is build - cyberspace: the new frontier. Much of the magic was lost or
        was never there to begin with but the basic idea of the internet (sites
        connceted by links) is very much alive and well and isn't going
        anywhere. Let's bring the magic back. Let's build beautiful tours
        through the web. Let's create Hitchhikers Guides to the world wide web,
        with treasure maps to our favorite sites.
      </p>
